  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto px-6 md:px-12 py-12">
        ...
        >
          <motion.h1 variants={itemVariants} className="text-4xl md:text-6xl font-extrabold text-white tracking-tighter leading-tight drop-shadow-md">
            Defining Style, Redefining Fashion.
          </motion.h1>
          <motion.p variants={itemVariants} className="mt-4 text-xl text-gray-200 max-w-3xl mx-auto">
        ...
        >
          <motion.div className="md:w-1/2" variants={itemVariants}>
            <h2 className="text-3xl font-bold text-white">The Art of Creation</h2>
        ...
        >
          <motion.div variants={itemVariants} className="bg-white/90 p-8 rounded-2xl shadow-lg transform transition duration-500 hover:shadow-2xl hover:-translate-y-2 backdrop-blur-sm">
            <Gem className="h-12 w-12 mx-auto text-red-600 mb-4" />
            <h3 className="text-2xl font-semibold text-gray-900">Exceptional Quality</h3>
          ...
          <motion.div variants={itemVariants} className="bg-white/90 p-8 rounded-2xl shadow-lg transform transition duration-500 hover:shadow-2xl hover:-translate-y-2 backdrop-blur-sm">
            ...
            <h3 className="text-2xl font-semibold text-gray-900">Sustainable Vision</h3>
            <p className="mt-2 text-gray-700">
          ...
          <motion.div variants={itemVariants} className="bg-white/90 p-8 rounded-2xl shadow-lg transform transition duration-500 hover:shadow-2xl hover:-translate-y-2 backdrop-blur-sm">
            ...
            <h3 className="text-2xl font-semibold text-gray-900">Modern Craftsmanship</h3>
            <p className="mt-2 text-gray-700">
